...
import com.sepanta.controlkit.votekit.theme.Orange100
...
class VoteViewPopover3 : VoteViewContract {
        ...
        Dialog(
            ...
            Surface(
                modifier = config.popupViewLayoutModifier ?: Modifier
                    .height(if ((response.voteOptions?.size ?: 0) > 1) 480.dp else 440.dp)
                    .fillMaxWidth(),
    ...
    private fun ButtonSubmit(
        ...
        config.submitButtonView?.let { button ->
            ...
            colors = ButtonDefaults.buttonColors(
                containerColor = config.submitButtonColor ?: Orange100
            ),
        ...
        Surface(
            ...
            config.closeButtonView?.let { button ->
                ...
                Surface(
                    modifier = Modifier
                        .width(28.dp)
                        .height(28.dp).align(Alignment.CenterEnd),
                    color = Color.Transparent,
                    onClick = {
                        viewModel.dismissDialog()
                    }
